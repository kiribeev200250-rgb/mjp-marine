...
const styles = StyleSheet.create({
  ...
  jobRow:    { flexDirection: 'row', paddingVertical: 6, paddingHorizontal: 4, backgroundColor: '#eef2f7', borderBottomWidth: 1, borderBottomColor: '#e2e5eb' },
  ...
  grandRow:  { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingVertical: 8, paddingHorizontal: 10, marginTop: 6, backgroundColor: NAVY, borderRadius: 4 },
  grandLabel:{ fontSize: 11, color: '#fff', fontWeight: 700 },
  grandValue:{ fontSize: 14, color: GOLD, fontWeight: 700 },
